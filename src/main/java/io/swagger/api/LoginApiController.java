...
public class LoginApiController implements LoginApi {
    ...
    public ResponseEntity<Boolean> login(
            @Parameter(in = ParameterIn.DEFAULT, description = "", required = true, schema = @Schema()) @RequestParam(value = "emailId", required = true) String emailId,
            @Parameter(in = ParameterIn.DEFAULT, description = "", required = true, schema = @Schema()) @RequestParam(value = "password", required = true) String password) {
